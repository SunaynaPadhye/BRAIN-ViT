...
# Corrected dictionary categorizing JHU ICBM-DTI-81 Atlas regions by relevance to AD and MCI
JHU_WM_regions = {
    "High Relevance": {
    ...
    "Low Relevance": {
        1: {"Description": "Unclassified"},
        2: {"Description": "Middle Cerebellar Peduncle"},
        3: {"Description": "Pontine Crossing Tract"},
        8: {"Description": "Corticospinal Tract (Right)"},
        9: {"Description": "Corticospinal Tract (Left)"},
        12: {"Description": "Inferior Cerebellar Peduncle (Right)"},
        13: {"Description": "Inferior Cerebellar Peduncle (Left)"},
        14: {"Description": "Superior Cerebellar Peduncle (Right)"},
        15: {"Description": "Superior Cerebellar Peduncle (Left)"},
        16: {"Description": "Cerebral Peduncle (Right)"},
        17: {"Description": "Cerebral Peduncle (Left)"},
        26: {"Description": "Superior Corona Radiata (Right)"},
        27: {"Description": "Superior Corona Radiata (Left)"},
        32: {"Description": "Sagittal Stratum (Right)"},
        33: {"Description": "Sagittal Stratum (Left)"},
        47: {"Description": "Tapetum (Right)"},
        48: {"Description": "Tapetum (Left)"}
    }
}
